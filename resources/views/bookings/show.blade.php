...
{{--            <h1 class="text-3xl lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">Отель {{ $booking->room->hotel->name }} - {{ \App\Services\ProjectEnumsService::hotelType()[$booking->room->hotel->type] }}</h1>--}}
{{--        </div>--}}
